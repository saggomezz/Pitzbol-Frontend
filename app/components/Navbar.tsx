        ...
        <nav className="flex justify-between items-center bg-[#F6F0E6] px-3 md:px-8 h-16 md:h-20 lg:h-24 sticky top-0 z-[100] shadow-sm text-[#1A4D2E]">
            ...
            <div className="flex items-center h-full gap-1">
                ...
                <div className="relative flex items-center h-full pointer-events-none">
                    <div className="absolute inset-y-0 -left-3 md:-left-5 top-4 md:top-5 lg:top-7 z-0 flex items-center w-[115%] md:w-[105%] min-w-[130px] md:min-w-[125px] lg:min-w-[220px]">
                    ...
                    {isMenuOpen && (
                        <>
                            ...
                            <motion.div
                                ...
                                className="fixed md:absolute top-[64px] bottom-3 md:bottom-auto md:top-[120%] right-2 md:right-0 w-[calc(100vw-1rem)] max-w-[340px] md:w-72 bg-white rounded-[24px] md:rounded-[32px] shadow-2xl border border-gray-100 p-4 md:p-5 flex flex-col gap-1 z-[120] overflow-y-auto md:max-h-[85vh] [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden"
                            >
                            ...
                            {user && (role === "turista" || role === "guia" || role === "admin") && (
                                <Link href="/perfil/pagos" onClick={() => setIsMenuOpen(false)} className="flex items-center gap-3 p-3 rounded-2xl text-sm font-medium transition-all text-left hover:text-[#F00808]">
                            ...
                            {role === "admin" ? (
                                ...
                                <>
                                    ...
                                    <Link href="/perfil/pagos" onClick={() => setIsMenuOpen(false)} className="flex items-center gap-3 p-3 rounded-2xl text-sm font-medium w-full text-left hover:text-[#F00808] transition-colors">
                                        <FiCreditCard /> {t('myPayments')}
                                    </Link>
                                    <div className="h-[1px] bg-gray-100 my-3 mx-2" />
                            ...
                            {/* Espaciador final para que el scroll llegue bien al final en móvil */}
