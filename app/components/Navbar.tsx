    ...
    return (
        <nav className="flex justify-between items-center bg-[#F6F0E6] px-3 md:px-8 h-16 md:h-20 lg:h-24 sticky top-0 z-[100] shadow-sm text-[#1A4D2E]">
            ...
            <div className="flex items-center h-full gap-1">
                <motion.div whileHover={{ rotate: 190 }} transition={{ duration: 2.0, ease: "easeInOut" }} className="relative h-24 w-24 md:h-20 md:w-20 lg:h-28 lg:w-28 flex-shrink-0 cursor-pointer">
                ...
                <div className="relative flex items-center h-full pointer-events-none">
                    <div className="absolute inset-y-0 -left-3 md:-left-5 top-6 md:top-5 lg:top-7 z-0 flex items-center w-[95%] md:w-[105%] min-w-[170px] md:min-w-[125px] lg:min-w-[220px]">
                        <Image src={imgPasto} alt="pasto" className="object-contain scale-[1.4] md:scale-100 origin-left" loading="eager" priority />
                    </div>
                    <h1 className="relative z-10 ml-1 md:ml-2 text-[36px] md:text-[28px] lg:text-[42px] leading-none drop-shadow-[2px_4px_4px_rgba(0,0,0,0.5)] text-white" style={{ fontFamily: "'Jockey One', sans-serif" }}>
