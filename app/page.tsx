                    ...
                    <Link href={categoryRoutes[activeCategory.name] || "/mapa"}>
                      ...
                      >
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-end p-6 text-center">
                          <h3 className="text-xl md:text-2xl font-black text-white uppercase drop-shadow-lg leading-tight" style={{ fontFamily: "var(--font-jockey)", WebkitTextStroke: "1px #1A4D2E" }}>
